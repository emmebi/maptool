...
public enum ButtonKind {
  ...
  CONTINUE(
      "CONTINUE", ButtonPanel.AFFIRMATIVE_BUTTON, "Button.continue", "Button.continue.mnemonic"),
  ...
  NETWORKING_HELP(
      "NETWORKING_HELP",
      ButtonPanel.HELP,
      "ServerDialog.button.networkinghelp",
      "ServerDialog.button.networkinghelp.mnemonic"),
